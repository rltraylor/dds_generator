...
//
void spi_init(void){ 
// ATMega8 specific SPI initalization
...
//in the array passed to it. This is not a particularly fast routine.
//
...
//is updated every mod 16 times. Interrupts occur at 131uS intervals.                     
...
ISR(TIMER2_COMP_vect){
  ...
  if((counter % 32)==0){refresh_lcd(lcd_string_array);} //update every 4ms
...
//DEBUG 
PORTC |= 0x20;  delay_us(1); PORTC &= ~0x20;
